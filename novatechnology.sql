...
-- Tiempo de generación: 14-09-2022 a las 15:50:51
...
CREATE TABLE `Cliente` (
  ...
  `contraseña` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Contraseña del cliente',
...
CREATE TABLE `cliente_empresa` (
  ...
  `nombre_empresa` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Nombre de la empresa'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `Cliente_web` (
  ...
  `Nombre_web` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Nombre del cliente web',
...
--
ALTER TABLE `Pedido`
  ADD PRIMARY KEY (`Nr°pedido`,`id_cliente`),
...
--
ALTER TABLE `Cliente`
  MODIFY `id_cliente` int NOT NULL AUTO_INCREMENT COMMENT 'Codigo con el cual se identifica al cliente';
...
--
ALTER TABLE `Variedad`
  ADD CONSTRAINT `FK` FOREIGN KEY (`id_especie`) REFERENCES `Especie` (`id_especie`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
